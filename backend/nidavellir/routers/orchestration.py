...
def _planner_pm_current_content(user_content: str) -> str:
    return "\n\n".join([
        ...
        "If the user approves implementation, respond by preparing handoff to decomposition/EM; do not proceed into Step 4/write tests/implement inside the PM chat.",
